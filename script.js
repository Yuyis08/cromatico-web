    ...
    const categorias = {
      papeleria: {
        ...
        productos: [
          ...
          { nombre: "Calendarios", descripcion: "Personalizados con tu marca.", imagen: "/img/calendario.png" }
        ]
      },
      textiles: {
        ...
        productos: [
          ...
          { nombre: "Gorras", descripcion: "Personalizadas con vinil o DTF.", imagen: "/img/gorra.png" }
        ]
      },
      productos: {
        ...
        productos: [
          ...
          { nombre: "Pines", descripcion: "Ideales para eventos o marcas.", imagen: "/img/pines.png" }
        ]
      },
      gran_formato: {
